...
import (
	...
	sm2 "github.com/warm3snow/gmsm/sm2"
)
...
func GetCertificate(certificate []byte) (*x509.Certificate, error) {
	...
	if block == nil {
		certificates, err = cspx509.ParseCertificates(certificate)
		if err != nil {
		...
		certificates, err = cspx509.ParseCertificates(block.Bytes)
		if err != nil {
...
func ParsePrivateKey(der []byte) (interface{}, error) {
	...
	if key, err := cspx509.ParsePKCS8PrivateKey(der); err == nil {
		...
		case *rsa.PrivateKey, *ecdsa.PrivateKey, *sm2.PrivateKey:
			return key, nil
		default:
			return nil, errors.New("Key is neither RSA nor ECDSA nor SM2")
		}
	}
	...
	if err != nil {
		return nil, fmt.Errorf("Failure parsing sm2 private key: %s", err)
	}
