...
var supportedSignatureAlgorithms = []signatureAndHash{
	...
	{hashSM3,  signatureSM2},
	{hashSHA256, signatureSM2},
}
...
const (
	...
	SM2WithSM3    SignatureScheme = 0x0407
	SM2WithSHA256 SignatureScheme = 0x0404
)
...
func ticketKeyFromBytes(b [32]byte) (key ticketKey) {
        ...
        hashfunc2 := sm3.New()
        var hashed [64]byte
        hashed1 := hashfunc1.Sum(b[:16])
        hashed2 := hashfunc2.Sum(b[16:])
        for i:=0; i < 32; i++ {
        	hashed[i] = hashed1[i]
                hashed[i+32] = hashed2[i]
        }
...
func initDefaultCipherSuites() {
	...
	topCipherSuites = []uint16{
		//TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305,
		//TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305,
                TLS_ECDHE_SM2_WITH_AES_128_GCM_SM3,
		TLS_ECDHE_SM2_WITH_AES_128_GCM_SHA256,
		TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256,
		TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384,
		TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256,
		TLS_ECDHE_SM2_WITH_AES_256_GCM_SHA384,
		TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384,
	}
	//}
